    ...
    return (
        <main>
            ...
            <div className="withdraw-complete-box">
                ...
                {/* 네이버 서비스 끊기 방법 유도 */}
                <p>네이버 회원분들은 <a className="service-unlink-url" href="https://nid.naver.com/user2/help/myInfo.nhn?menu=authList">[ 네이버 서비스 연결끊기 ]</a>를 통해 서비스를 해제할 수 있습니다.</p>
                {/* 카카오 서비스 끊기 유도 */}
                <p>카카오 회원분들은 <a className="service-unlink-url" href="https://accounts.kakao.com/weblogin/account/link">[ 카카오 서비스 연결끊기 ]</a>를 통해 서비스를 해제할 수 있습니다.</p>
